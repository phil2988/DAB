...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment_2.Tables.RoomBooking", b =>
                {
                    ...
                    b.Property<int?>("BookedByMemberMemberId")
                        .HasColumnType("int");

                    b.Property<long?>("BookedBySocietySocietyCvr")
                        .HasColumnType("bigint");

                    b.Property<string>("LocationAdress")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("RoomForeignKey")
                        .HasColumnType("int");

                    b.HasKey("RoomBookingId");

                    b.HasIndex("BookedByMemberMemberId");

                    b.HasIndex("BookedBySocietySocietyCvr");
            ...
            modelBuilder.Entity("Assignment_2.Tables.Room", b =>
                {
                    ...
                    b.HasOne("Assignment_2.Tables.RoomBooking", "RoomBookings")
                        .WithMany("Room")
                        .HasForeignKey("RoomId")
            ...
            modelBuilder.Entity("Assignment_2.Tables.RoomBooking", b =>
                {
                    b.HasOne("Assignment_2.Tables.Member", "BookedByMember")
                        .WithMany()
                        .HasForeignKey("BookedByMemberMemberId");

                    b.HasOne("Assignment_2.Tables.Society", "BookedBySociety")
                        .WithMany()
                        .HasForeignKey("BookedBySocietySocietyCvr");

                    b.Navigation("BookedByMember");

                    b.Navigation("BookedBySociety");
                });

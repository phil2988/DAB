...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Assignment_2.Activity", b =>
                {
            ...
            modelBuilder.Entity("Assignment_2.Chairman", b =>
                {
            ...
            modelBuilder.Entity("Assignment_2.LocationProperty", b =>
                {
            ...
            modelBuilder.Entity("Assignment_2.Member", b =>
                {
            ...
            modelBuilder.Entity("Assignment_2.Municipality", b =>
                {
            ...
            modelBuilder.Entity("Assignment_2.MunicipalityLocation", b =>
                {
                    b.Property<string>("LocationAdress")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
            ...
            modelBuilder.Entity("Assignment_2.Room", b =>
                {
                    b.Property<int>("RoomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Assignment_2.Society", b =>
                {
                    b.Property<long>("SocietyCvr")
                        .HasColumnType("bigint")
                        .HasColumnName("societyCvr");
            ...
            modelBuilder.Entity("Assignment_2.SocietyMemberRelation", b =>
                {
                    b.Property<int>("MemberId")
                        .HasColumnType("int")
                        .HasColumnName("memberId");
            ...
            modelBuilder.Entity("Assignment_2.Member", b =>
                {
                    b.HasOne("Assignment_2.MunicipalityLocation", "LocationAdressNavigation")
                        .WithMany("Members")
                        .HasForeignKey("LocationAdress")
                        .HasConstraintName("FK_Member.locationAdress");

                    b.HasOne("Assignment_2.Room", "Room")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("Assignment_2.Municipality", b =>
                {
                    b.HasOne("Assignment_2.Society", "SocietyCvrNavigation")
                        .WithMany()
            ...
            modelBuilder.Entity("Assignment_2.MunicipalityLocation", b =>
                {
                    b.HasOne("Assignment_2.LocationProperty", "Property")
            ...
            modelBuilder.Entity("Assignment_2.Society", b =>
                {
                    b.HasOne("Assignment_2.Activity", "ActivityNameNavigation")
                        .WithMany("Societies")
                        .HasForeignKey("ActivityName")
                        .HasConstraintName("FK_Society.activityName");

                    b.HasOne("Assignment_2.Chairman", "ChairmanNameNavigation")
                        .WithMany("Societies")
            ...
            modelBuilder.Entity("Assignment_2.SocietyMemberRelation", b =>
                {
                    b.HasOne("Assignment_2.Member", "Member")
                        .WithMany()
